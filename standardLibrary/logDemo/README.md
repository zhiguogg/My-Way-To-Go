...
//output
2020/12/26 15:48:19 简单使用log
2020/12/26 15:48:19 这是我不是归人的日志
2020/12/26 15:48:19 这是一条会触发fatal的日志
exit status 1  
```
...
log.SetFlags(log.Llongfile | log.Lmicroseconds | log.Ldate)
	log.Println("简单使用log")
// output
2020/12/26 15:54:54.806744 /Users/moss/My-Way-To-Go/standardLibrary/logDemo/main.go:7: 简单使用log
```
...
//output
2020/12/26 15:57:38.826267 /Users/moss/My-Way-To-Go/standardLibrary/logDemo/main.go:7: 简单使用log
golang:2020/12/26 15:57:38.826420 /Users/moss/My-Way-To-Go/standardLibrary/logDemo/main.go:10: 这是我不是归人的日志
```
...
例如，下面的代码会把日志输出到同目录下的`logDemo.log`文件中。
